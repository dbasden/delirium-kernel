...
#define ICMP_PRELUDE	\
	u_int8_t	type		__packme;\
	u_int8_t	code		__packme;\
...
struct IPv4_ICMP_Unreachable {
	ICMP_PRELUDE
	u_int32_t		_unused		__packme;
	struct IPv4_Header	orig_header	__packme;
...
struct IPv4_ICMP_Redirect {
	ICMP_PRELUDE
	IPv4_Address		gateway		__packme; // Where to redir to
	struct IPv4_Header	orig_header	__packme; 
	u_int8_t		context[]	__packme;
} __packme;
...
struct IPv4_ICMP_Param_Problem {
	ICMP_PRELUDE
	u_int8_t		error_ptr	__packme;
	u_int8_t		_unused_a	__packme;
	u_int16_t		_unused_b	__packme;
	struct IPv4_Header	orig_header	__packme;
	u_int8_t		context[]	__packme;
} __packme;
